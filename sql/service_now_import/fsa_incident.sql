...
SELECT 
	...
	LEFT(category,60),
	LEFT(subcategory,60),
	CASE WHEN LOWER([u_first_time_fix_nonsla]) = 'true' THEN 1 ELSE 0 END as fcr,
	...
	'Failure',
	active,
	u_project_related AS projectrelated,
...
target.projectrelated = source.projectrelated,
